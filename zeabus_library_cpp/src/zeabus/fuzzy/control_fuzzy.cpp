...
int check_error(int current, int previous)
{
...
{
    int error = 0;
    if(crisp < -1 && crisp >= -3.14)
    {
        error = -3;
    }
    else if(crisp < -0.5 && crisp >= -1)
    {
        error = -2;
    }
    else if(crisp < 0 && crisp >= -0.5)
    {
        error = -1;
    }
    else if(crisp == 0)
...
{ 
    ...
    /*
    if(crisp < 0.5 && crisp > 0)
    {
        output = 1;
    }
    else if(crisp < 0.5 && crisp > 0)
    {
        output = -1;
    }
    */
