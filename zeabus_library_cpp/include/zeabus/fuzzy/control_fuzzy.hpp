...
int crisp_to_error(double crisp);  // this function will get value from crisp for change before input to current_error

int crisp_to_output(int fuzzy_value); // this function will get value from output_fuzzy for change before output value from system