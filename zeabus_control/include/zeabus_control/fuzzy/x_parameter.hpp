...
namespace x_parameter
{
    ...
    //  Data is vector type
    const std::array< double , 4 > FORCE_RULE = { 0.05 , 0.15 , 0.30 , 3 };
    ...
    const std::array< std::array < std::array< int , 7 > , 7 > , 7 > FUZZY_RULE =
        ...
        //  -3  -2  -1  +0  +1  +2  +3  = CASE error fuzzy
            ...
            +3, +3, +3, +3, +2, +4, +4, // CASE diff fuzzy = -2
        ...
        //  -3  -2  -1  +0  +1  +2  +3  = CASE error fuzzy
            ...
            +2, +2, +2, +2, +2, +3, +3, // CASE diff fuzzy = -2
        ...
        //  -3  -2  -1  +0  +1  +2  +3  = CASE error fuzzy
            ...
            -3, -3, -2, -2, -2, -2, -2, // CASE diff fuzzy = +2
        ...
        //  -3  -2  -1  +0  +1  +2  +3  = CASE error fuzzy
            ...
            -4, -4, -2, -3, -3, -3, -3, // CASE diff fuzzy = +2
            -4, -4, -2, -3, -3, -3, -3  // CASE diff fuzzy = +3
    };
}
