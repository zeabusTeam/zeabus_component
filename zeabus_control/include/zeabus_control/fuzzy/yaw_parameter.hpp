...
namespace yaw_parameter
{
    ...
    // Data is vector type
    const std::array< double , 3 > ERROR_RULE = { 0.08 , 0.4 , 0.6 };
    
    // Diff is range to decision about velocity error will be 0 1 2 3 by use 3 value
    // Data is vertor type
    const std::array< double , 3 > DIFF_RULE = { 0.005 , 0.05 , 0.12 };
    ...
    //  Data is vector type
    const std::array< double , 4 > FORCE_RULE = { 0.03 , 0.08 , 0.16 , 1};
    ...
    const std::array< double , 5 > DEFUZZY_RULE = {0.01 , 0.03 , 0.04, 0.06, 0.10 };
    ...
    const std::array< std::array< std::array < int , 7 >, 7 >, 7 > FUZZY_RULE = 
    {
        ...
        //  -3  -2  -1  +0  +1  +2  +3  = CASE error fuzzy
            +3, +3, +3, +4, +3, +3, +3, // CASE diff fuzzy = -3
            +2, +2, +2, +4, +2, +2, +2, // CASE diff fuzzy = -2
            +0, +0, +0, +4, +2, +2, +3, // CASE diff fuzzy = -1
            -0, -0, -0, +0, +1, +1, +1, // CASE diff fuzzy = -0
            -0, -0, -0, -0, +0, -0, -0, // CASE diff fuzzy = +1
            -0, -0, -0, -0, -0, -0, -0, // CASE diff fuzzy = +2
            -0, -0, -0, -0, -0, -0, -0, // CASE diff fuzzy = +3
        
        // CASE fuzzy force = -2
        //  -3  -2  -1  +3  +1  +2  +3  = CASE error fuzzy
            +2, +3, +4, +4, +4, +4, +4, // CASE diff fuzzy = -3
            +2, +2, +3, +3, +4, +4, +4, // CASE diff fuzzy = -2
            +0, +0, +0, +3, +3, +3, +4, // CASE diff fuzzy = -1
            -1, -1, -1, +0, +2, +2, +1, // CASE diff fuzzy = -0
            -2, -2, -2, -3, +0, -1, -1, // CASE diff fuzzy = +1
            -3, -2, -2, -3, -1, -1, -1, // CASE diff fuzzy = +2
            -4, -4, -3, -3, -2, -2, -2, // CASE diff fuzzy = +3
        
        // CASE fuzzy force = -1
        //  -3  -2  -1  +0  +1  +2  +3  = CASE error fuzzy
            +2, +2, +2, +2, +2, +2, +3, // CASE diff fuzzy = -3
            +2, +2, +2, +2, +2, +2, +2, // CASE diff fuzzy = -2
            +0, +0, +0, +1, +1, +1, +2, // CASE diff fuzzy = -1
            -1, -1, -1, +0, +1, +1, +1, // CASE diff fuzzy = -0
            -2, -2, -1, -2, +0, -1, -1, // CASE diff fuzzy = +1
            -3, -2, -2, -2, -2, -1, +1, // CASE diff fuzzy = +2
            -3, -3, -2, -4, -3, -2, +1, // CASE diff fuzzy = +3
        ...
        //  -3  -2  -1  +0  +1  +2  +3  = CASE error fuzzy
            ...
            +1, +1, +0, +1, +2, +2, +3, // CASE diff fuzzy = -1
        ...
        //  -3  -2  -1  +0  +1  +2  +3  = CASE error fuzzy
            ...
            +1, +1, +0, +1, +2, +2, +2, // CASE diff fuzzy = -1
            -2, -1, -2, +0, +1, +1, +1, // CASE diff fuzzy = -0
            -2, -2, -3, -3, +0, +0, +0, // CASE diff fuzzy = +1
            -3, -3, -3, -3, -2, -2, -1, // CASE diff fuzzy = +2
            -3, -3, -3, -3, -2, -2, -1, // CASE diff fuzzy = +3
        
        // CASE fuzzy force = +3
        //  -3  -2  -1  +0  +1  +2  +3  = CASE error fuzzy
            +2, +2, +3, +6, +4, +6, +6, // CASE diff fuzzy = -3
            +1, +1, +2, +6, +4, +6, +6, // CASE diff fuzzy = -2
            +1, +1, +0, +6, +4, +5, +1, // CASE diff fuzzy = -1
            -2, -1, -1, +0, +1, +1, +1, // CASE diff fuzzy = -0
            -2, -2, -2, -3, +0, +0, +0, // CASE diff fuzzy = +1
            -3, -3, -3, -3, +0, +0, +0, // CASE diff fuzzy = +2
            -3, -3, -3, -3, -0, +0, +0  // CASE diff fuzzy = +3
    };
